...
export default function Dropdown({
  ...
  return (
    <div className="relative flex flex-col rounded">
      ...
      {show && (
        <div className="absolute overflow-y-scroll bottom-0 right-0 z-[100] flex min-w-full translate-y-[calc(100%+3px)] flex-col items-stretch rounded border border-gray-300 bg-white py-2 shadow">
